...
`0.4.0-alpha.1`이며, 안정 버전 전까지 공개 API가 변경될 수 있습니다.

## 무엇부터 읽어야 하나요?

처음 사용하는 경우 다음 순서를 권장합니다.

1. [처음부터 따라 하는 사용자 설명서](user-guide.md)
2. [처음부터 회전하는 큐브까지](getting-started.md)
3. [장면, 객체, 변형과 복합 모델](scene-and-modeling.md)
4. [객체 이동과 메시 모양 변형](mesh-deformation.md)
5. [Playground 실습 안내](playground.md)
6. [여러 사진으로 3D 만들기](../photo-reconstruction.md)
7. [자연어 명령과 AI Provider 설정](natural-language.md)
8. 자동 생성된 [API 문서](../../site/api/index.html)
...
- 기준 정점 기반의 늘이기·굽히기·비틀기·테이퍼·물결 메시 변형
