...
const examples = [
  ...
  },
  {
    ...
    level: "advanced",
    topic: "rendering",
    description: "Compose vision stages, refine depth and project photo colors onto safe geometry.",
    learning: "AI enhancers, camera poses, cancellable visual hulls and vertex-color projection.",
