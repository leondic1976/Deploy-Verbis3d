...
offline segmentation, visual-hull geometry, remote vision payloads, provider mesh validation and
buffer-geometry round-trip.
...
photo-workflow demo reconstruction, vision provider privacy controls, viewport picking, orbit/zoom,
